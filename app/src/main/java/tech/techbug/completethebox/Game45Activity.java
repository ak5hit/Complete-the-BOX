...
public class Game45Activity extends AppCompatActivity {
    ...
    private void fillLeftBox(int row, int column) {
        ...
        int id = Game45Activity.this.getResources().getIdentifier(strid, "id",
                Game45Activity.this.getPackageName());
    ...
    private void isGameCompletedThanDo() {
        if(p1Boxs+p2Boxs == 20) {
            Intent winnerIntent = new Intent(Game45Activity.this, WinnerActivity.class);
